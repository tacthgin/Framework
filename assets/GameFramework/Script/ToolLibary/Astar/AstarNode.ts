...
export class AstarNode {
    ...
    private _position: IAstarVec2 = null!;
     ...
     */
    constructor(index: number, position: IAstarVec2, hValue: number, parentNode: AstarNode | null = null) {
     ...
     * @param parentNode 父结点
     */
    initialize(index: number, position: IAstarVec2, hValue: number, parentNode: AstarNode | null = null) {
        this._index = index;
