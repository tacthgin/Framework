...
export class CHotUpdateHelper implements IHotUpdateHelper {
    private _assetManager: native.AssetsManager = null!;
    ...
    private initHotUpdate(manifestUrl: string): void {
        ...
        this._assetManager = new native.AssetsManager("", storagePath, this.versionCompareHandle);
    ...
    private checkUpdate(): void {
        ...
        if (this._assetManager.getState() === native.AssetsManager.State.UNINITED) {
